            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form:form modelAttribute="user" method="POST" class="user">
                    <div class="form-group">
                      <form:input type="text" class="form-control form-control-user" path="username" aria-describedby="emailHelp" placeholder="Nhập tài khoản..."/>
                    </div>
                    <div class="form-group">
                      <form:input type="password" class="form-control form-control-user" path="password" id="exampleInputPassword" placeholder="Nhập mật khẩu"/>
                    </div>
                    <div class="form-group">
                    ...
                    ${mes}
                    <button value="login" name="login" class="btn btn-primary btn-user btn-block">
                      Đăng nhập
                    </button>
                    <hr>
                    </form:form> 
